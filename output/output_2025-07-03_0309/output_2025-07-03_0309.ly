...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" c4 | %{ bar 3: %}
 \note-mod "1" c4
 \note-mod "1" c4  \note-mod "1" c4  \note-mod "1" c4 | %{ bar 4: %} \set stemLeftBeamCount = #0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \transpose c c { \key c \major  \time 4/4 c''''1 | %{ bar 2: %} c'2 c'2 | %{ bar 3: %} c'4 c'4 c'4 c'4 | %{ bar 4: %} c''8 c''8 c''8 c''8 c''8 c''8 c''8 c''8 | %{ bar 5: %} c16 c16 c16 c16 c16 c16 c16 c16 c16 c16 c16 c16 c16 c16 c16 c16 } } }
% === END MIDI STAFF ===
