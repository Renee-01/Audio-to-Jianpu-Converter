...
%% === BEGIN JIANPU STAFF ===
    ...
    \override Staff.Stem #'transparent = ##t
     \mark \markup{1=F} \time 4/4 \set stemLeftBeamCount = #0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { \transpose c f { \key c \major  \time 4/4 e''8 f''8 g''8 d''8 r8 g'8 e''16 d''8 e''16 | %{ bar 2: %} e'2 r4 e'16. f'16. g'16 } } }
% === END MIDI STAFF ===
