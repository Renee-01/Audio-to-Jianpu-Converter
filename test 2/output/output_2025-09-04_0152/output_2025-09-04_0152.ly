...
q1, q#1, q2, q#2, q3, q4, q#4, q5, | q#5, q6, q#6, q7, q1 q#1 q2 q#2 | q3 q4 q#4 q5 q#5 q6 q#6 q7 | q1' q#1' q2' q#2' q3' q4' q#4' q5' | q#5' q6' q#6' q7' q1'' q#1'' q2'' q#2'' | q3'' q4'' q#4'' q5'' q#5'' q6'' q#6'' h0 h0 h0 h0 h0 h0 h0 h0 |
%}
...
\set stemRightBeamCount = #1
 \note-mod "1" \once \tweak Accidental.extra-offset #'(0 . 0.7)cis8-\tweak #'X-offset #0.6 _. ]
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "2" d8-\tweak #'X-offset #0.6 _. [
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 \note-mod "2" \once \tweak Accidental.extra-offset #'(0 . 0.7)dis8-\tweak #'X-offset #0.6 _. ]
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
...
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "4" \once \tweak Accidental.extra-offset #'(0 . 0.7)fis8-\tweak #'X-offset #0.6 _. [
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "6" \once \tweak Accidental.extra-offset #'(0 . 0.7)ais8-\tweak #'X-offset #0.6 _. [
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
...
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 \note-mod "1" \once \tweak Accidental.extra-offset #'(0 . 0.7)cis8]
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "2" d8[
\set stemLeftBeamCount = #1
...
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "4" \once \tweak Accidental.extra-offset #'(0 . 0.7)fis8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 \note-mod "5" g8]
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "5" \once \tweak Accidental.extra-offset #'(0 . 0.7)gis8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 \note-mod "6" a8]
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "6" \once \tweak Accidental.extra-offset #'(0 . 0.7)ais8[
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
 \note-mod "7" b8]
...
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "1" c8-\tweak #'X-offset #0.6 ^\two-dots [
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "1" \once \tweak Accidental.extra-offset #'(0 . 0.7)cis8-\tweak #'X-offset #0.6 ^\two-dots ]
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "2" d8-\tweak #'X-offset #0.6 ^\two-dots [
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "2" \once \tweak Accidental.extra-offset #'(0 . 0.7)dis8-\tweak #'X-offset #0.6 ^\two-dots ]
| | %{ bar 6: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "3" e8-\tweak #'X-offset #0.6 ^\two-dots [
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "4" f8-\tweak #'X-offset #0.6 ^\two-dots ]
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "4" \once \tweak Accidental.extra-offset #'(0 . 0.7)fis8-\tweak #'X-offset #0.6 ^\two-dots [
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "5" g8-\tweak #'X-offset #0.6 ^\two-dots ]
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "5" \once \tweak Accidental.extra-offset #'(0 . 0.7)gis8-\tweak #'X-offset #0.6 ^\two-dots [
\set stemLeftBeamCount = #1
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "6" a8-\tweak #'X-offset #0.6 ^\two-dots ]
\set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "6" \once \tweak Accidental.extra-offset #'(0 . 0.7)ais8-\tweak #'X-offset #0.6 ^\two-dots [
\set stemLeftBeamCount = #1
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { c8 cis8 d8 dis8 e8 f8 fis8 g8 | | %{ bar 2: %} gis8 a8 ais8 b8 c'8 cis'8 d'8 dis'8 | | %{ bar 3: %} e'8 f'8 fis'8 g'8 gis'8 a'8 ais'8 b'8 | | %{ bar 4: %} c''8 cis''8 d''8 dis''8 e''8 f''8 fis''8 g''8 | | %{ bar 5: %} gis''8 a''8 ais''8 b''8 c'''8 cis'''8 d'''8 dis'''8 | | %{ bar 6: %} e'''8 f'''8 fis'''8 g'''8 gis'''8 a'''8 ais'''8 r64 r64 r64 r64 r64 r64 r64 r64 | } }
% === END MIDI STAFF ===
