...
1, #1, 2, #2, | 3, 4, #4, 5, | #5, 6, #6, 7, | 1 #1 2 #2 | 3 4 #4 5 | #5 6 #6 7 | 1' #1' 2' #2' | 3' 4' #4' 5' | #5' 6' #6' 7' | 1'' #1'' 2'' #2'' | 3'' 4'' #4'' 5'' | #5'' 6'' #6'' 0 |
%}
...
%% === BEGIN JIANPU STAFF ===
 ...
 \note-mod "1" \once \tweak Accidental.extra-offset #'(0 . 0.7)cis4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 \note-mod "2" d4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 \note-mod "2" \once \tweak Accidental.extra-offset #'(0 . 0.7)dis4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
| | %{ bar 2: %}
 \note-mod "3" e4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 \note-mod "4" f4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
 \note-mod "4" \once \tweak Accidental.extra-offset #'(0 . 0.7)fis4-\tweak #'Y-offset #-1.2 -\tweak #'X-offset #0.6 _. 
...
| | %{ bar 8: %}
 ...
 \note-mod "6" a4^.  \note-mod "6" \once \tweak Accidental.extra-offset #'(0 . 0.7)ais4^.
 \note-mod "7" b4^. | | %{ bar 10: %}
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "1" c4-\tweak #'X-offset #0.6 ^\two-dots 
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "1" \once \tweak Accidental.extra-offset #'(0 . 0.7)cis4-\tweak #'X-offset #0.6 ^\two-dots 
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "2" d4-\tweak #'X-offset #0.6 ^\two-dots 
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "2" \once \tweak Accidental.extra-offset #'(0 . 0.7)dis4-\tweak #'X-offset #0.6 ^\two-dots 
| | %{ bar 11: %}
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "3" e4-\tweak #'X-offset #0.6 ^\two-dots 
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "4" f4-\tweak #'X-offset #0.6 ^\two-dots 
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "4" \once \tweak Accidental.extra-offset #'(0 . 0.7)fis4-\tweak #'X-offset #0.6 ^\two-dots 
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "5" g4-\tweak #'X-offset #0.6 ^\two-dots 
| | %{ bar 12: %}
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "5" \once \tweak Accidental.extra-offset #'(0 . 0.7)gis4-\tweak #'X-offset #0.6 ^\two-dots 
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "6" a4-\tweak #'X-offset #0.6 ^\two-dots 
  \once \override Score.TextScript.outside-staff-priority = 45 \note-mod "6" \once \tweak Accidental.extra-offset #'(0 . 0.7)ais4-\tweak #'X-offset #0.6 ^\two-dots 
 \note-mod "0" r4 | \bar "|." } }
% === END JIANPU STAFF ===
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { c4 cis4 d4 dis4 | | %{ bar 2: %} e4 f4 fis4 g4 | | %{ bar 3: %} gis4 a4 ais4 b4 | | %{ bar 4: %} c'4 cis'4 d'4 dis'4 | | %{ bar 5: %} e'4 f'4 fis'4 g'4 | | %{ bar 6: %} gis'4 a'4 ais'4 b'4 | | %{ bar 7: %} c''4 cis''4 d''4 dis''4 | | %{ bar 8: %} e''4 f''4 fis''4 g''4 | | %{ bar 9: %} gis''4 a''4 ais''4 b''4 | | %{ bar 10: %} c'''4 cis'''4 d'''4 dis'''4 | | %{ bar 11: %} e'''4 f'''4 fis'''4 g'''4 | | %{ bar 12: %} gis'''4 a'''4 ais'''4 r4 | } }
% === END MIDI STAFF ===
