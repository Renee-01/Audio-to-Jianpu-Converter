...
%% === BEGIN JIANPU STAFF ===
 ...
 ~  \note-mod "–" f4 \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0 | %{ bar 3: %}
 \note-mod "4" f4
 ~ \once \override Tie #'transparent = ##t \once \override Tie #'staff-position = #0  \note-mod "–" f4
 ~  \note-mod "–" f4  \note-mod "4" f4 | %{ bar 4: %}
 \note-mod "4" f4
 \note-mod "4" f4  \note-mod "4" f4  \note-mod "4" f4 | %{ bar 5: %}
 \note-mod "4" f4.
 \note-mod "4" f4.  \note-mod "4" f4 | %{ bar 6: %} \set stemLeftBeamCount = #0
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { f'1 | %{ bar 2: %} f'2 f'2 | %{ bar 3: %} f'2. f'4 | %{ bar 4: %} f'4 f'4 f'4 f'4 | %{ bar 5: %} f'4. f'4. f'4 | %{ bar 6: %} f'8. f'8. f'8. f'8. f'8 f'8 | %{ bar 7: %} f'16 f'16 f'16 f'16 f'16. f'16. f'16. f'16. f'16. f'16. f'16. f'16. } }
% === END MIDI STAFF ===
