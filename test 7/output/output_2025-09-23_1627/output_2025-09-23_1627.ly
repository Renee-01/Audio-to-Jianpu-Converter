...
4 ~ q4 4 ~ q4 4 | 4 ~ q4 4 ~ q4 4 | 4 ~ q4 4 ~ q4 4 | 4 ~ q4 4 ~ q4 4 | 4 ~ q4 4 ~ q4 4 | 4 ~ q4 4 ~ q4 4 ~ | q4 0 0 0 q0 |
%}
...
\set stemRightBeamCount = #1
 \note-mod "4" f8[]
 \note-mod "4" f4 ~ | | %{ bar 7: %} \set stemLeftBeamCount = #0
\set stemRightBeamCount = #1
 \note-mod "4" f8[
...
% === BEGIN MIDI STAFF ===
    \new Staff { \new Voice="X" { f'4 ~ f'8 f'4 ~ f'8 f'4 | | %{ bar 2: %} f'4 ~ f'8 f'4 ~ f'8 f'4 | | %{ bar 3: %} f'4 ~ f'8 f'4 ~ f'8 f'4 | | %{ bar 4: %} f'4 ~ f'8 f'4 ~ f'8 f'4 | | %{ bar 5: %} f'4 ~ f'8 f'4 ~ f'8 f'4 | | %{ bar 6: %} f'4 ~ f'8 f'4 ~ f'8 f'4 ~ | | %{ bar 7: %} f'8 r2. r8 | } }
% === END MIDI STAFF ===
